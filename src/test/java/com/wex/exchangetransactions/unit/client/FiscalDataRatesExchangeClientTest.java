package com.wex.exchangetransactions.unit.client;

import com.wex.exchangetransactions.client.FiscalDataRatesExchangeClient;
...
class FiscalDataRatesExchangeClientTest {
    ...
    @InjectMocks
    private FiscalDataRatesExchangeClient exchangeClient;
